...
namespace InvoiceCustomerPropertyEditor.Blazor.Server {
    public partial class InvoiceCustomerPropertyEditorBlazorApplication : BlazorApplication {
        public InvoiceCustomerPropertyEditorBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void InvoiceCustomerPropertyEditorBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
